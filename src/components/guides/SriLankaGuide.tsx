  ...
  return (
    <>
      ...
      >
        ...
        <p className="text-gray-600 leading-relaxed mb-6">
          From misty tea country to ancient temples to wildlife safaris, a consultant can
          help you build the right Sri Lanka itinerary. Request a free, personalised quote
          today.
        </p>
        <Link href="/contact">
