    ...
    <>
      ...
      >
        <h2 className="font-primary font-bold text-[#1a1a1a] text-2xl leading-tight mb-3">
          Plan Your Australia Family Getaway
        </h2>
        <p className="text-gray-600 leading-relaxed mb-6">
          From Sydney&apos;s iconic harbour to Melbourne&apos;s laneway culture, a
          consultant can help you plan the right Australia itinerary timed around your
          school holidays. Request a free, personalised quote today.
        </p>
        <Link href="/contact">
