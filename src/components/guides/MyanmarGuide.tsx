    ...
    <>
      ...
      >
        <h2 className="font-primary font-bold text-[#1a1a1a] text-2xl leading-tight mb-3">
          Plan your Myanmar cultural journey
        </h2>
        <p className="text-gray-600 leading-relaxed mb-6">
          From Bagan&rsquo;s ancient temple plain to Yangon&rsquo;s golden pagodas, a consultant
          can help you plan a meaningful Myanmar itinerary. Request a free, personalised quote
          today.
        </p>
        <Link href="/contact">
