    ...
    <>
      ...
      <section className="relative bg-teal-navy overflow-hidden min-h-[420px] lg:min-h-[500px] flex items-end">
        ...
        <div className="relative z-10 w-full max-w-6xl mx-auto px-6 lg:px-12 pb-12 lg:pb-16">
          ...
          >
            For Muslims who wish to enjoy their holiday, however, it should not be enough to
            have an excellent view of the area or stay in good accommodation; it is also
            ...
            Muslim tour package and the destinations where such tourism plans can be made.
          </motion.p>
        ...
        <div className="max-w-6xl mx-auto px-6 lg:px-12">
          ...
          >
            <h2 className="font-primary font-bold text-[#1a1a1a] text-2xl leading-tight mb-3">
              Plan Your Muslim-Friendly Holiday
            </h2>
            <p className="text-gray-600 leading-relaxed mb-6 max-w-2xl">
              Travel with confidence knowing your halal food and prayer needs are genuinely
              planned for, not an afterthought. Request a free, personalised quote today.
            </p>
            <Link href="/contact">
              <Button variant="light" showArrow size="lg">
                Request a Free Quote
