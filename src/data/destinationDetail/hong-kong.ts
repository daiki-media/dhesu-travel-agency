...
export const HONG_KONG_THEMES: HongKongLandingPage[] = [
  {
    ...
    intro:
      "The allure of Hong Kong for the average Malaysian holidaymaker, most especially family groups, is due to the city’s distinctive offering of state-of-the-art theme park entertainment, bustling shopping areas, and a convenient and easily-navigable urban layout. This article takes a look at what an average holiday to Hong Kong involves and how it suits short breaks.",
